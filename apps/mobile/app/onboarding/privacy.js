      ...
      <View style={styles.content}>
        ...
        <View style={styles.card}>
          <View style={styles.row}>
            ...
            <Switch value={dataPublic} onValueChange={setDataPublic} trackColor={{ false: 'rgba(255,255,255,.1)', true: COLORS.gold + '55' }} thumbColor={dataPublic ? COLORS.gold : 'rgba(255,255,255,.3)'}/>
          </View>
          ...
          <View style={[styles.row, styles.rowLast]}>
            ...
            <Switch value={inRanking} onValueChange={setInRanking} trackColor={{ false: 'rgba(255,255,255,.1)', true: COLORS.gold + '55' }} thumbColor={inRanking ? COLORS.gold : 'rgba(255,255,255,.3)'}/>
          </View>
        </View>
