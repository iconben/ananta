...
export function CampaignSheet({ visible, onClose, editCampaign, defaultPracticeId }: Props) {
  ...
  return (
    <Sheet visible={visible} onClose={onClose} title={editCampaign ? '编辑发愿' : '新建发愿'}>
